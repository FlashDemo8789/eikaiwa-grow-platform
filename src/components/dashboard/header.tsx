            ...
            <DropdownMenuItem>
              <div className="flex flex-col space-y-1">
                ...
                <p className="text-xs text-muted-foreground">
                  Tanaka Hiroshi enrolled in Advanced English course
                </p>
              </div>
            </DropdownMenuItem>
            <DropdownMenuItem>
              <div className="flex flex-col space-y-1">
                ...
                <p className="text-xs text-muted-foreground">
                  Sato Yuki's payment for March is overdue
                </p>
              </div>
            </DropdownMenuItem>
            <DropdownMenuItem>
              <div className="flex flex-col space-y-1">
                ...
                <p className="text-xs text-muted-foreground">
                  Intermediate class starts in 30 minutes
                </p>
              </div>
            </DropdownMenuItem>
          </DropdownMenuContent>
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent className="w-56" align="end" forceMount>
            <DropdownMenuLabel className="font-normal">
              <div className="flex flex-col space-y-1">
                <p className="text-sm font-medium leading-none">Yamada Sensei</p>
                <p className="text-xs leading-none text-muted-foreground">
                  teacher@eikaiwa-grow.com
                </p>
              </div>
            </DropdownMenuLabel>
            <DropdownMenuSeparator />
