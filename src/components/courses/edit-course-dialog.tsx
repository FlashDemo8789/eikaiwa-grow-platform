...
import { CalendarDays, DollarSign, BookOpen, Plus, X } from "lucide-react"
...
export function EditCourseDialog({ children, course, onSave }: EditCourseDialogProps) {
  ...
  useEffect(() => {
    if (open && course) {
      setFormData({
        ...
        lessonsPerWeek: course.lessonsPerWeek.toString(),
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Modify course details, curriculum, pricing, and enrollment settings.
          </DialogDescription>
        </DialogHeader>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <div className="text-sm text-muted-foreground">
                  Current enrollment: {course.enrolled} students
                </div>
              </div>
            </div>
